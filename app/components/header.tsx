...
const MenuItem: React.FC<RemixLinkProps> = (props) => (
  <li>
    <Link
      className="hover:underline text-green-main font-bold uppercase text-xl"
      {...props}
    />
  </li>
);
...
const DropdownMenuItem: React.FC<{
  ...
  <li className="group relative">
    ...
    {items.length ? (
      <div className="group-hover:block dropdown-menu hidden md:absolute h-auto -left-3 shadow-lg absolute">
...
export const Header = () => {
  ...
  return (
    <header className="w-max lg:w-auto">
